...
public class SystemAccountDaoImpl implements SystemAccountDAO {
    private static final Logger logger = Logger.getLogger(SystemAccountDaoImpl.class.getCanonicalName());
	...
	try {
	    ...
	    logger.log(Level.SEVERE, " ERROR when create System User. Message: " + ex.getMessage());
	...
	if (!listUser.isEmpty()) {
		...
		logger.log(Level.SEVERE, " ERROR when deleteAllDomainUser. Message: " + ex.getMessage());
		pm.currentTransaction().rollback();
		throw ex;
	    } finally {
		pm.close();
	...
	try {
	    ...
	    logger.log(Level.SEVERE, " ERROR when createGoogleAccount. Message: " + ex.getMessage());
	    pm.currentTransaction().rollback();
	    throw ex;
	} finally {
	    pm.close();
	...
	try {
	    ...
	    logger.log(Level.SEVERE, " ERROR when deleteGoogleAccount. Message: " + ex.getMessage());
	    pm.currentTransaction().rollback();
	    throw ex;
	} finally {
	    pm.close();
	...
	try {
	    ...
	    logger.log(Level.SEVERE, " ERROR when getSystemUserByEmail. Message: " + e.getMessage());
	    throw e;
	} finally {
	    pm.close();
	}
	...
	try {
	    ...
	    logger.log(Level.SEVERE, " ERROR when getGoogleAccountById. Message: " + ex.getMessage());
	    pm.currentTransaction().rollback();
	    throw ex;
	} finally {
	    pm.close();
	...
	try {
	    ...
	    logger.log(Level.SEVERE, " ERROR when listAllGoogleAccount. Message: " + e.getMessage());
	    throw e;
	} finally {
	    pm.close();
	}
	...
	if (temp != null) {
		...
		logger.log(Level.SEVERE, " ERROR when deleteSystemUser. Message: " + ex.getMessage());
		pm.currentTransaction().rollback();
		ex.printStackTrace();
		throw ex;
	    } finally {
	...
	if (temp != null) {
		...
		logger.log(Level.SEVERE, " ERROR when updateSystemUser. Message: " + ex.getMessage());
		pm.currentTransaction().rollback();
		throw ex;
	    } finally {
		pm.close();
	...
	try {
	    ...
	    logger.log(Level.SEVERE, " ERROR when getSystemUserById. Message: " + e.getMessage());
	    throw e;
	} finally {
	    pm.close();
	}
