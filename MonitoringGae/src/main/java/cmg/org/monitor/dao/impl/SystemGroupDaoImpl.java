...
public class SystemGroupDaoImpl implements SystemGroupDAO {
    private static final Logger logger = Logger.getLogger(SystemGroupDaoImpl.class.getCanonicalName());
	...
	try {
	    ...
	    logger.log(Level.SEVERE, " ERROR when addNewGroup. Message: " + ex.getMessage());
	...
	try {
	    ...
	    logger.log(Level.SEVERE, " ERROR when getByID. Message: " + ex.getMessage());
	    throw ex;
	} finally {
	    pm.close();
	}
	...
	try {
	    ...
	    logger.log(Level.SEVERE, " ERROR when updateGroup. Message: " + ex.getMessage());
	    pm.currentTransaction().rollback();
	    throw ex;
	} finally {
	    pm.close();
	...
	try {
	    ...
	    logger.log(Level.SEVERE, " ERROR when deleteGroup. Message: " + ex.getMessage());
	    pm.currentTransaction().rollback();
	    throw ex;
	} finally {
	    pm.close();
	...
	try {
	    ...
	    logger.log(Level.SEVERE, " ERROR when getAllGroup. Message: " + e.getMessage());
	    throw e;
	} finally {
	    pm.close();
	}
