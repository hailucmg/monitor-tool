...
public class MonitorAbout implements EntryPoint {

	private final MonitorAboutServiceAsync aboutSv = GWT
			.create(MonitorAboutService.class);
	@Override
